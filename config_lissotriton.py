# =============== CONFIG Lissotriton vulgaris ===============================================================================================
NE_RATIOS = [0.15, 0.25]        # Ne / Nc
GEN_TIME_YEARS = (3, 4)               # min, max (years per generation)
MIGRANTS_PER_YEAR = [0.5, 4, 8]      # immigration (breeders/year)

TIME_HORIZON_YEARS = 200              # years
...
K = 100                         # carrying capacity (breeding adults)
THETA = 1.0                     # θ for theta-logistic; 1.0 reduces to logistic

H0 = 0.60                 # starting observed heterozygosity (species/population)
H_MIN_FRAC = 0.50         # must retain at least Z% of starting heterozygosity by T
GEN_TIME_FOR_GENETICS = 3    # if None, uses GEN_TIME_YEARS[0] (shortest)
...
R_GRID = [-0.05, 0.0, 0.05]           # mean growth per year
SIGMA_E_GRID = [0.25, 0.35]           # env. stochasticity (SD on ln scale)
